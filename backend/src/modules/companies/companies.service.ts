  ...
  async update(id: string, data: UpdateCompanyInput) {
    ...
    return prisma.company.update({
      ...
      data: {
        ...
        ...(data.onboardingPdfUrl !== undefined && { onboardingPdfUrl: data.onboardingPdfUrl === '' ? null : data.onboardingPdfUrl }),
        ...(data.contractPdfUrl !== undefined && { contractPdfUrl: data.contractPdfUrl === '' ? null : data.contractPdfUrl }),
